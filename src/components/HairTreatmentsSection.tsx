  ...
  return (
    <div className="rounded-3xl overflow-hidden">
      <Animate
        ...
        className="relative glass-card p-6 md:p-8 flex flex-col gap-4 cursor-default hover-lift reveal-animate h-full"
      >
        ...
        <div>
          <h3 className="ar-text font-bold" style={{ fontSize: "clamp(1rem, 3vw, 1.25rem)", color: "var(--text-primary)", letterSpacing: 0 }}>
            {title}
          </h3>
          {subtitle && (
            <p className="ar-text mt-1" style={{ fontSize: "0.85rem", color: "var(--text-muted)", letterSpacing: 0 }}>
              {subtitle}
            </p>
          )}
        </div>
        <div className="flex items-center gap-1.5 mt-auto pt-4" style={{ borderTop: "1px solid var(--border)" }}>
  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <SectionTitle title={t.treatments.title} subtitle={t.treatments.subtitle} />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 rounded-3xl overflow-hidden">
            <Animate
              ...
              className="relative glass-card hover-lift reveal-animate h-full"
            >
              <div className="absolute top-0 inset-x-0 h-px"
              ...
              <div className="p-6 md:p-8">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <p className="section-label mb-1 ar-text" style={{ color: "var(--text-muted)", letterSpacing: 0 }}>
                      {t.treatments.specializedTreatment}
                    </p>
                    <h3 className="ar-text font-bold"
                      style={{ fontSize: "clamp(1.1rem, 3vw, 1.4rem)", color: "var(--text-primary)", letterSpacing: 0 }}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  {collagenTiers.map((tier, i) => (
                    ...
                    >
                      <p className="ar-text font-medium mb-3" style={{ fontSize: "0.9rem", color: "var(--text-primary)", letterSpacing: 0 }}>
                        {tier.label}
                      </p>
