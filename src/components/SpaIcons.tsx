...
/* ── WhatsApp — elegant line-art icon ── */
export function WhatsAppIcon(p: IconProps) {
  return (
    <IconBase {...p}>
      {/* Speech bubble with tail */}
      <path d="M7 25 L4.5 30 L9.5 28.5 C11.3 29.5 13.6 30 16 30 C23.7 30 30 23.7 30 16 C30 8.3 23.7 2 16 2 C8.3 2 2 8.3 2 16 C2 18.4 2.5 20.7 3.5 22.5 Z" />
      {/* Handset inside */}
      <path d="M21 18.5 C20.6 18.2 20 17.9 19.8 17.9 C19.5 17.9 19.3 18.1 19.1 18.3 L18.6 19 C18.1 18.7 17.7 18.4 17.3 18 C16.9 17.6 16.6 17.2 16.3 16.7 L17 16.2 C17.2 16 17.4 15.8 17.4 15.5 C17.4 15.4 17.2 15 17 14.7 C16.8 14.4 16.5 14 16.2 13.7 C16 13.4 15.7 13.3 15.5 13.3 C15.2 13.3 15 13.4 14.8 13.6 C14.4 14 14 14.7 14 15.4 C14 16.7 14.6 18 15.7 19.1 C16.8 20.2 18.1 20.8 19.4 20.8 C20.1 20.8 20.8 20.4 21.2 20 C21.4 19.8 21.5 19.6 21.5 19.4 C21.5 19.2 21.4 19 21 18.5 Z" />
    </IconBase>
  );
}
